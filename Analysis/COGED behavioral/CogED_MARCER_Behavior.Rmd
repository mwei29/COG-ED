...
(coged.fmri.hardChoice.group <- coged.fmri.hardChoice %>%
  ...
  summarise(meanPropHard = mean(propHard), sdPropHard = sd(propHard)))
# Visualize
ggplot(coged.fmri.hardChoice.group,
       aes(x = Age.Group, y = meanPropHard, 
           fill = MDD_Status)) +
  geom_bar(stat = "identity", position = position_dodge(width = 0.9)) +
  geom_errorbar(aes(ymin = meanPropHard - sdPropHard,
                    ymax = meanPropHard + sdPropHard),
                width = 0.2,
                position = position_dodge(width = 0.9)) +
  scale_x_discrete(labels = c("MA" = "35–54 y/o", "OA" = "55–74 y/o")) +
  scale_y_continuous(limits = c(0, 1)) +
  scale_fill_manual(values = c("HC" = "#1f78b4",   # blue
                               "MDD" = "#ffcc00")) + # yellow
  labs(x = "Age Group",
       y = "Mean Proportion of Choosing High-Effort Option",
       fill = "MDD Status",
       title = "Hard Choice Proportion by Age and MDD Status") +
...
fig.RT <- ggplot(fixed_pred, aes(x=proximityValue, y=Predicted)) + 
 ...
 theme_classic() + labs(x= "Proximity", y="Reaction Time")
