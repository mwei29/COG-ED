...
glm.path <- "/scratch2/weie/COGED_CODE/HC_parcelStats/COGED_parcelStats/";  
...
@
\noindent \texttt{groupGLMs\textunderscore HC\textunderscore COGED\textunderscore Schaefer\textunderscore vol.rnw} \par
\noindent compiled \today\  \par
\noindent \textbf{group} MARCER HC COGED group GLM results, volumes. \par
\vspace{0.2 cm} 
