...
Started by MW in 12/10/24 to analyze MARCER COGED full behavioral data. I have updated a lot of code compared to the original version to make it cleaner.
...
# eth.tbl <- read_excel(paste0(in.path,"ethnicity.xlsx"))
...
nback.lab <- left_join(nback.lab, demo %>% 
                       select(sub.id, Group.Assignment, Age.Group), 
